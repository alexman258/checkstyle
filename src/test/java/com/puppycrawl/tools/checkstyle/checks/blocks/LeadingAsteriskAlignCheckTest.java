...
public class LeadingAsteriskAlignCheckTest extends AbstractModuleTestSupport {
	...
	public void testLeadingAsteriskAlignCheck() throws Exception {
		final DefaultConfiguration checkConfig = createModuleConfig(LeadingAsteriskAlignCheck.class);
		final String[] expected = { "17: " + getCheckMessage(LEADING_ASTERISK_NOT_ALIGNED),
