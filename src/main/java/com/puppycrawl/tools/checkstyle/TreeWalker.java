...
public final class TreeWalker extends AbstractFileSetCheck implements ExternalResourceHolder {
     ...
     */
    @Override
    public void setupChild(final Configuration childConf)
    ...
    private SortedSet<LocalizedMessage> getFilteredMessages(
            final String fileName, final FileContents fileContents, final DetailAST rootAST) {
     ...
     * @throws CheckstyleException if Check is misconfigured
     */
    private void registerCheck(final String token, final AbstractCheck check) throws CheckstyleException {
        if (check.isCommentNodesRequired()) {
     ...
     */
    private void walk(final DetailAST ast, final FileContents contents,
            final AstState astState) {
     ...
     * @param astState state of AST.
     */
    private void notifyBegin(final DetailAST rootAST, final FileContents contents,
            final AstState astState) {
     ...
     * @param astState state of AST.
     */
    private void notifyEnd(final DetailAST rootAST, final AstState astState) {
        final Set<AbstractCheck> checks;
     ...
     * @param astState state of AST.
     */
    private void notifyVisit(final DetailAST ast, final AstState astState) {
     ...
     * @param astState state of AST.
     */
    private void notifyLeave(final DetailAST ast, final AstState astState) {
        final Collection<AbstractCheck> visitors = getListOfChecks(ast, astState);
     ...
     */
    private Collection<AbstractCheck> getListOfChecks(final DetailAST ast, final AstState astState) {
     ...
     */
    private static Set<String> getExternalResourceLocationsOfChecks(final Set<AbstractCheck> checks) {
        final Set<String> externalConfigurationResources = new HashSet<>();
     ...
     * @param astState state of AST.
     */
    private void processIter(final DetailAST root, final AstState astState) {
